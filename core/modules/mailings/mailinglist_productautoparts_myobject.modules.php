...
dol_include_once("/productautoparts/class/myobject.class.php");


/**
 * mailing_mailinglist_productautoparts
 */
class mailing_mailinglist_productautoparts_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_productautoparts_myobject';
	...
	var $picto='productautoparts@productautoparts';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('productautoparts', $conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/productautoparts/myobject_card.php', 1).'?id='.$id.'">'.img_object('', "generic").'</a>';
	}
	...
	function add_to_target($mailing_id)
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_productautoparts_myobject.modules.php: mailing ".$num." targets found");
