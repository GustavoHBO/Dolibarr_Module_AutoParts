...
/**
 * \file    modulebuilder/template/core/boxes/productautopartswidget1.php
 * \ingroup productautoparts
 * \brief   Widget provided by ProductAutoParts
 *
 ...
 */
class productautopartswidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "productautopartsbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "productautoparts@productautoparts";
	 ...
	 */
	public $depends = array('productautoparts');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->productautoparts->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/productautoparts/class/productautoparts.class.php";

		// Populate the head at runtime
		$text = $langs->trans("ProductAutoPartsBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_productautoparts@productautoparts',
