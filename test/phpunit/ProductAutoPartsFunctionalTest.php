...
/**
 * \file    test/functional/ProductAutoPartsFunctionalTest.php
...
/**
 * Class ProductAutoPartsFunctionalTest
 *
 ...
 *
 * @package Testproductautoparts
 */
class ProductAutoPartsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modProductAutoParts')->click();
		} else {
			// Disable the module
			$this->byHref('modProductAutoParts')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/productautoparts/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('productautoparts/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/productautoparts/admin/about.php');
		$this->authenticate();
		return $this->assertContains('productautoparts/admin/about.php', $this->url(), 'About page');
	}
...
return $this->assertEquals(
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('productautopartswidget1', $this->source(), "Box enabled");
	}
...
return $this->assertContains(
			'interface_99_modProductAutoParts_ProductAutoPartsTriggers.class.php',
...
return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modProductAutoParts_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
