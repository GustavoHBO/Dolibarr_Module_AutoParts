...
/**
 *	\file       htdocs/productautoparts/template/productautopartsindex.php
 *	\ingroup    productautoparts
 *	\brief      Home page of productautoparts top menu
 */
...
$langs->loadLangs(array("productautoparts@productautoparts"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->productautoparts->read) accessforbidden();
...
llxHeader("", $langs->trans("ProductAutoPartsArea"));

print load_fiche_titre($langs->trans("ProductAutoPartsArea"), '', 'productautoparts.png@productautoparts');
...
// Draft MyObject
if (! empty($conf->productautoparts->enabled) && $user->rights->productautoparts->read)
{
	$langs->load("orders");
